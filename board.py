...
class BoardSquare(IntEnum):
    ...
    # Specify values instead of range for static analysis
    A1, B1, C1, D1, E1, F1, G1, H1 = 0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07
    A2, B2, C2, D2, E2, F2, G2, H2 = 0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x17
    A3, B3, C3, D3, E3, F3, G3, H3 = 0x20,0x21,0x22,0x23,0x24,0x25,0x26,0x27
    A4, B4, C4, D4, E4, F4, G4, H4 = 0x30,0x31,0x32,0x33,0x34,0x35,0x36,0x37
    A5, B5, C5, D5, E5, F5, G5, H5 = 0x40,0x41,0x42,0x43,0x44,0x45,0x46,0x47
    A6, B6, C6, D6, E6, F6, G6, H6 = 0x50,0x51,0x52,0x53,0x54,0x55,0x56,0x57
    A7, B7, C7, D7, E7, F7, G7, H7 = 0x60,0x61,0x62,0x63,0x64,0x65,0x66,0x67
    A8, B8, C8, D8, E8, F8, G8, H8 = 0x70,0x71,0x72,0x73,0x74,0x75,0x76,0x77

# Convenience alias
SQ = BoardSquare

# for square computation, use int but give it a special name
square = int
